    ...
    <VRow no-gutters align="center" justify="center" class="fill-height">
      <VCol cols="12" md="6" lg="5" sm="6">
        <VRow no-gutters align="center" justify="center">
          <VCol cols="12" md="6">
            <h1>Crear Cuenta</h1>
            <p class="text-medium-emphasis">Ingresa tus datos para registrarte</p>
            ...
            <VForm @submit.prevent="submit" class="mt-7">
              ...
              <div class="mt-5">
                <VBtn type="submit" block min-height="45" class="gradient primary">Registrarse</VBtn>
              </div>
            </VForm>
            <p class="text-body-2 mt-10">
              <span>¿Ya tienes cuenta?
                <NuxtLink to="/" class="font-weight-bold text-primary">Inicia Sesión</NuxtLink>
              </span>
            </p>
          </VCol>
        </VRow>
      ...
      <VCol class="hidden-md-and-down fill-height" md="6" lg="7">
        <VImg src="https://wallpaper.dog/large/5557744.jpg" cover
          ...
          <div class="text-center w-50 text-white mx-auto">
            <h2 class="mb-4">Únete hoy mismo</h2>
            <p>
