...
export { dashboards, isSuperAdmin, canAccessCompanyDashboard, canAccessHealup, canAccessBrada, canAccessOrigitec, canAccessAlef, canAccessClinicaArroyo, canAccessAlegrated, canAccessGrijalva, canAccessJamleo, canAccessSoletanche, getDashboardPathByCompanyId, UserSession } from '../utils/permissions';
